...
for experiment in experiments_list:
	...
	for model in models_list_50km_EC_EARTH:
		...
		# CONSTRUCT RCM FILE NAMES
		#  New root for non-bias corrected (!nbc!) files:
		pr_nbc_file_root_hist = "prAdjust_EUR-44_"+model+"_"+experiment+"_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
		pr_nbc_file_root_proj = "prAdjust_EUR-44_"+model+"_"+experiment+"_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
