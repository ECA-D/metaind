...
# #models_list_12km = ['MPI-M-MPI-ESM-LR']
...
# indice_list_pp = ['PRCPTOT']  #R95p RX1day RR1 PRCPTOT
# #indice_pp = 'RR1'
# # =========================================================================
...
# 	#files_pr_12km = [in_path_RCM_pr_12km+pr_12km_file_root+"19810101-21001231.nc"]
...
for model in models_list_12km_HadGEM:
	...
	# Explicit list
	files_pr_12km = [in_path_RCM_pr_12km+pr_12km_file_root+"19700101-19701230.nc",
	                 in_path_RCM_pr_12km+pr_12km_file_root+"19710101-19751230.nc",
	                 in_path_RCM_pr_12km+pr_12km_file_root+"19760101-19801230.nc",
	                 in_path_RCM_pr_12km+pr_12km_file_root+"19810101-19851230.nc",
...
# 	pr_12km_file_root="prAdjust_EUR-11_"+model+"_rcp45_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
...
# #yymmdd_dt1=int(2006,01,01)
# # 25years periods for RAM in RR1 work [20060101-203001231], [20310101-20551231], [20560101-20801231], [20810101-21001231]
# # periods for RAM in R95p work [20060101-20101231]
# yy_dt1=2081
# mm_dt1=01
# dd_dt1=01
# #
...
# 	pr_12km_file_root="prAdjust_EUR-11_"+model+"_rcp45_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-MESAN-1989-2010_day_"
# 	#print pr_12km_file_root
