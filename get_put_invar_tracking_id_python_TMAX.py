...
for experiment in experiments_list:
	...
	in_path_RCM_tasmax_nbc_50km=nobackup+"CLIPC/Model_data/tasmax/"+experiment+"/50km/daily/SMHI_DBS43_2006_2100/"
	out_path_RCM_tasmax_nbc_50km=nobackup+"icclim_indices_v4.2.3_seapoint_fixed/EUR-44/"+experiment+"/tasmax/"
	...
	for model in models_list_50km:
		...
		tasmax_nbc_file_root_hist = "tasmaxAdjust_EUR-44_"+model+"_"+experiment+"_r1i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
		tasmax_nbc_file_root_proj = "tasmaxAdjust_EUR-44_"+model+"_"+experiment+"_r1i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
	...
	for model in models_list_50km_EC_EARTH:
		...
		# CONSTRUCT RCM FILE NAMES
		#  New root for non-bias corrected (!nbc!) files:
		tasmax_nbc_file_root_hist = "tasmaxAdjust_EUR-44_"+model+"_"+experiment+"_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
		tasmax_nbc_file_root_proj = "tasmaxAdjust_EUR-44_"+model+"_"+experiment+"_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
