...
# 14.03.2016. This version only does minimum temperatures indices: FD
# ============================================================================================
...
# Precip
in_path_RCM_tasmin_50km=nobackup_stepanov+"CLIPC/Model_data/tasmin/rcp45/50km/daily/SMHI_DBS43_2006_2100/"
out_path_RCM_tasmin_50km=nobackup_stepanov+"icclim_indices/RCM/tasmin/50km/"
...
for model in models_list_50km:
	...
	tasmin_50km_file_root="tasminAdjust_EUR-44_"+model+"_rcp45_r1i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
	#print pr_50km_file_root

	# Explicit list
	files_tasmin_50km = [in_path_RCM_tasmin_50km+tasmin_50km_file_root+"19810101-19851231.nc",
...
# =========================================================================
	...
	for indice_tasmin in indice_list_tasmin:
		...
		calc_indice_tasmin = out_path_RCM_tasmin_50km+indice_tasmin+"_"+model+'_tasmin.nc'
...
# 	# Explicit list
# 	files_tasmin_50km = [in_path_RCM_tasmin_50km+tasmin_50km_file_root+"19810101-19851230.nc",
...
# 	tasmin_50km_file_root="tasminAdjust_EUR-44_"+model+"_rcp45_r12i1p1_SMHI-RCA4_v1-SMHI-DBS43-EOBS10-1981-2010_day_"
