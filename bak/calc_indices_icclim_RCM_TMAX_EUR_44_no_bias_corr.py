...
# ==============================================================
# Should work for input parameters: maximum temperature (tasmax)
# ==============================================================
...
in_path_RCM_tasmax_nbc_50km=nobackup+"CLIPC/Model_data/no_bias_corr/EUR-44/rcp45/day/tasmax/SMHI/all_models/"
out_path_RCM_tasmax_nbc_50km=nobackup+"icclim_indices_v4.2.3/EUR-44/rcp45/tasmax_no_bc/"
...
for model in models_list_50km:
	...
	tasmax_nbc_file_root_proj = "tasmax_EUR-44_"+model+"_rcp45_r1i1p1_SMHI-RCA4_v1_day_"
...
# 			                 in_path_RCM_tasmax_nbc_50km+tasmax_nbc_file_root_proj+"20960101-20991130.nc"]
...
# 	tasmax_nbc_file_root_proj = "tasmax_EUR-44_"+model+"_rcp45_r12i1p1_SMHI-RCA4_v1_day_"
