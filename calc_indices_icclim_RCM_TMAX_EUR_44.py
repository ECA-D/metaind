...
# Tmax
in_path_RCM_pr_50km=nobackup+"CLIPC/Model_data/tasmax/rcp45/50km/daily/SMHI_DBS43_2006_2100/"
out_path_RCM_pr_50km=nobackup+"icclim_indices_v4.2.3/EUR-44/tasmax/"
# =====================================================================================================
...
for model in models_list_50km_EC_EARTH:
	...
	tasmaxint 'All input Model files:', files_tasmax_50km
